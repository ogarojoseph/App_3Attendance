...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "IT";
	String year = "YEAR 1";
	String subject = "DATABASE MANAGEMENT";

	private String[] branchString = new String[] { "IT"};
	private String[] yearString = new String[] {"YEAR 1","YEAR 2","YEAR 3","YEAR 4"};
	private String[] subjectSEString = new String[] {"OFFICE AUTOMATION","DATA STRUCTURES"};
	private String[] subjectTEString = new String[] {"DATABASE MANAGEMENT","INFORMATION ASSURANCE"};
	private String[] subjectBEString = new String[] {"PROJECT MANAGEMENT","ARTIFICIAL AGENTS"};

	private String[] subjectFinal = new String[] {"OFFICE AUTOMATION","DATA STRUCTURES","INFORMATION ASSURANCE","ARTIFICIAL AGENTS","DATABASE MANAGEMENT","PROJECT MANAGEMENT"};
